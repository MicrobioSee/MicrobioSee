...
shinyUI(fluidPage(
  ...
  titlePanel(h2("rose_plot"),windowTitle = "MicrobioSee"),
  ...
  sidebarLayout(
    ...
    mainPanel(
      #创建下载按钮
      # downloadButton("downloadpdf", label="Download_pdf"),
      # downloadButton("downloadpng", label="Download_png"),
      # downloadButton("downloadjpeg", label="Download_jpeg"),
      # downloadButton("download4", label="Download_svg"),
      plotOutput("roseplot")
    )
